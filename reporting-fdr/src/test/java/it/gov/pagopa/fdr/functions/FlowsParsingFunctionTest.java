...
class FlowsParsingFunctionTest {
  ...
  @Mock OptionsService optionsService;

  @InjectMocks FlowsParsingFunction function;
  ...
  void runOkTest() throws IOException {
    ...
    assertDoesNotThrow(
        () ->
            function.run(
                file,
                "AGID_01--97735020584--97735020584_03--77777777777--2022-02-02AGID_01-S003035679--2022-02-02T00_30_49.xml",
                context));

    verify(optionsService)
        .optionsProcessing(
            anyString(),
            anyString(),
            any(),
